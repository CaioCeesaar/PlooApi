    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipeUsuario", x => new { x.EquipesId, x.UsuariosId });
                    table.ForeignKey(
                        name: "FK_EquipeUsuario_Equipes_EquipesId",
                        column: x => x.EquipesId,
                        principalTable: "Equipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipeUsuario_Usuarios_UsuariosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipeUsuario_UsuariosId",
                table: "EquipeUsuario",
                column: "UsuariosId");
        }
